  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 font-inter text-primary">
      <header className="max-w-6xl mx-auto px-6 py-6 flex items-center justify-between">
        <div className="text-2xl font-extrabold">Yonex</div>
        <nav className="space-x-6 hidden md:flex">
          <a className="text-gray-600 hover:text-gray-900">Product</a>
      ...
      <main className="max-w-6xl mx-auto px-6 py-20 flex flex-col-reverse md:flex-row items-center gap-12">
        <section className="flex-1 animate-fade-in-up">
          ...
          <p className="mt-6 text-gray-600 max-w-xl">Lightweight frames, engineered strings, and professional-grade materials — everything you need to play at your best. Built from the Figma design as a starter page.</p>
          <div className="mt-8 flex gap-4">
            <a href="#" className="px-6 py-3 bg-accent text-white rounded-md shadow hover:bg-sky-500 transition">Shop now</a>
            <a href="#" className="px-6 py-3 border border-gray-200 rounded-md hover:bg-gray-50 transition">Learn more</a>
          </div>
          <p className="mt-4 text-sm text-gray-500">Figma file: <a className="text-accent" href="https://www.figma.com/design/OvNserY3UcS6gaTOx7iK5W/Untitled?node-id=0-1&t=ot9PLuz8Y54Ez8A2-1" target="_blank" rel="noreferrer">Open design</a></p>
        </section>
      ...
      <footer className="border-t mt-16">
        <div className="max-w-6xl mx-auto px-6 py-8 text-sm text-gray-500">© {new Date().getFullYear()} Yonex — built from Figma slide</div>
      </footer>
    </div>
  )
}
